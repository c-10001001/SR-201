...
#
# Source:
# stackoverflow.com/questions/1908878/netcat-implementation-in-python#1909355
...
def val_vars(
            ...
            valid = False
            parts = host.split(".")
            # If host was not split into 4 octets False will be returned.
            if len(parts) != 4:
                print ("Invalid IPv4")
                return valid
            ...
            for item in parts:
                if item.isdigit():
                    ...
                    print (item, "Could not be broken down into valid digits.")
                    return valid
